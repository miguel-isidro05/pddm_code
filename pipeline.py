    ...
    def _generate_ddpm_paper_figures() -> None:
        ...
        for ch_name, ch_idx in zip(wanted, ch_idxs):
            ...
            for tt in t_grid_forward:
                ...
                ax_f_p.plot(f1[m], p1[m], color=color_forward, lw=1.2, alpha=0.95)
                ax_f_p.grid(alpha=0.15, lw=0.3)
                ax_f_p.set_xticks([])
                ax_f_p.set_yticks([])
            ...
            for tt in reverse_steps:
                ...
                ax_r_p.plot(f1[m], p1[m], color=color_reverse, lw=1.2, alpha=0.95)
                ax_r_p.grid(alpha=0.15, lw=0.3)
                ax_r_p.set_xticks([])
                ax_r_p.set_yticks([])
        ...
        for row_i, ch_name in enumerate(wanted):
            ...
            for cond_name, pwr in [("original", pwr_o), ("hybrid", pwr_d)]:
                ...
                duration_s = float(x4_real.shape[1]) / float(sf)
