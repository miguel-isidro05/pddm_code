...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Backbone para score model. scorenet-unet (SGDM.py) suele dar mejor Pearson.",
    )
    ...
    if not args.skip_sgm:
        ...
        # Optional: load ScoreNet-style UNet from SGDM.py (Gaussian Fourier + GroupNorm)
        def _load_sgdm_unet():
        ...
        for spec in EXPERIMENTS:
            ...
            if args.sgm_backbone == "scorenet-unet":
                ...
                t_embed_scale = None  # SGDM UNet expects continuous t
            else:
                model = UNet(in_channels=3, out_channels=1, n_feat=64, time_emb_dim=256).to(device)
