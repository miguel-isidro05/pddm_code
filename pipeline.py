...
def main() -> None:
    ...
    parser.add_argument("--eegnet-lr", type=float, default=1e-4, help="Learning rate for EEGNet (Adam).")
    parser.add_argument("--eegnet-dropout", type=float, default=0.3, help="Dropout rate inside EEGNet.")
