...
def train_score_model_vp(
    *,
    ...
    for step in pbar:
        ...
        # IMPORTANTE: nuestro backbone `UNet` usa `SinusoidalPosEmb` pensado para DDPM
        # con t ~ [0..1000). Para score-SDE usamos t continuo en (0,1], así que lo
        # escalamos a una magnitud comparable para que el time-embedding sea informativo.
        t_embed = t * float(sde.N)
        ...
        score = model(model_input, t_embed)
