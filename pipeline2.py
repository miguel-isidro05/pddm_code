...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="low-mi",
        choices=["low-mi", "farthest"],
        help="How to auto-select target channels: low-mi (data-driven) or farthest (geometry-based).",
    )
    parser.add_argument(
        "--show-target-mi",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="When --target-selection=low-mi, print the MI ranking of candidate channels.",
    )
    ...
    if bool(args.auto_specs):
        specs = _auto_experiments_2a(
            ...
            show_mi=bool(args.show_target_mi),
        )
    else:
