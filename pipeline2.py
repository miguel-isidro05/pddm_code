...
def run_fbcsp_lda_safe(
    *,
    ...
    if best_reg is None and not bool(tune):
        best_reg = None
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=True,
        help="Tune FBCSP hyperparameters on TRAIN via CV (recommended).",
    )
    parser.add_argument("--fbcsp-k-best", type=int, default=4, help="Used when --no-fbcsp-tune.")
    parser.add_argument("--fbcsp-m-pairs", type=int, default=2, help="Used when --no-fbcsp-tune.")
